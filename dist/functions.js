...
const courses = ["HTML/CSS", "Backend 1"];
const courseIds = [1, 2];
const date = new Date(); // Could be implicit
...
function calculateTotalRevised(price, quantity, discount, taxRate) {
    let total = price * quantity;
    switch (discount) {
        case "30%":
            total * 0.7;
